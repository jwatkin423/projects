...
/***/ "./node_modules/jquery.event.move/js/jquery.event.move.js":
/***/ (function(module, exports, __webpack_require__) {
 ...
 */
__webpack_require__("./node_modules/jquery.event.move/js/jquery.event.move.js");

window.matchHeight = __webpack_require__("./resources/assets/js/legacy/match-height.js");

__webpack_require__("./resources/assets/js/legacy/reduce-menu.js");
__webpack_require__("./resources/assets/js/legacy/responsive-slider.js");
__webpack_require__("./resources/assets/js/legacy/faq.js");
...
/***/ "./resources/assets/js/legacy/faq.js":
/***/ (function(module, exports) {
...
/***/ "./resources/assets/js/legacy/match-height.js":
/***/ (function(module, exports) {

module.exports = function (objects, cols, nomatch) {
  "use strict";
  ...
  for (i in objCatArr) {
    ...
    if (!nomatch) $(objCatArr[i]).height(max);
  }
...
/***/ "./resources/assets/js/legacy/reduce-menu.js":
/***/ (function(module, exports) {
...
/***/ "./resources/assets/js/legacy/responsive-slider.js":
/***/ (function(module, exports) {
...
(function () {
  ...
  (function ($) {
    ...
    Slider.prototype = {
      getGlobalWidth: function getGlobalWidth() {
      ...
      hideAnimatedCaptions: function hideAnimatedCaptions(slide) {
        return $(this.$slides[slide - 1]).find('[data-animate]').css({
          'opacity': 0
        });
      },
      calculateScroll: function calculateScroll(slide) {
        var gWidth;
      ...
      jump: function jump(slide, transitionTime, noanimation) {
      ...
      prev: function prev(transitionTime, noanimation) {
        if (transitionTime == null) {
          transitionTime = this.options.transitionTime;
        }
        if (noanimation == null) {
      ...
      next: function next(transitionTime, noanimation) {
        if (transitionTime == null) {
          transitionTime = this.options.transitionTime;
        }
        if (noanimation == null) {
    ...
    $.fn.responsiveSlider = function (option) {
      ...
      r = this;
      options = $.extend({}, $.fn.responsiveSlider.defaults, (typeof option === 'undefined' ? 'undefined' : _typeof(option)) === 'object' && option);
    ...
    $.fn.responsiveSlider.animations = {
      slideAppearRightToLeft: function slideAppearRightToLeft($caption, delay, length) {
        var animate, css;
        if (delay == null) {
          delay = 0;
        }
      ...
      slideAppearLeftToRight: function slideAppearLeftToRight($caption, delay, length) {
        var animate, css;
        if (delay == null) {
          delay = 0;
        }
      ...
      slideAppearUpToDown: function slideAppearUpToDown($caption, delay, length) {
        var animate, css;
        if (delay == null) {
          delay = 0;
        }
      ...
      slideAppearDownToUp: function slideAppearDownToUp($caption, delay, length) {
        var animate, css;
        if (delay == null) {
          delay = 0;
        }
    ...
    $.fn.responsiveSlider.defaults = {
      ...
      onSlidePageChange: function onSlidePageChange() {},
