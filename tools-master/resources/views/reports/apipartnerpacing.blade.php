...
@section('content')
  <div class="row">
    <div class="col-lg-6">
      <div class="box">
        <div class="box-header">
          <h2><i class="fa fa-calendar"></i>Select API Partner</h2>
        </div>
        <div class="box-content" id="date-range-filter">
          {!! Form::model($date_filter, ['action' => 'ReportController@getAPIPartnerPacing', 'class' => 'form-horizontal', 'method' => 'get']) !!}
          <fieldset class="col-lg-12">
            <div class="form-group">
              {!! Form::label('api_partner', 'API Partners:', ["class" => "control-label"]) !!}
              <div class="controls">
                {!! Form::select('api_partner', $api_partners, null, ['class' => 'form-control']) !!}
              </div>
            </div>
    ...
    <div class="col-lg-6">
      <div class="box">
        <div class="box-header">
          <h2><i class="fa fa-align-justify"></i>Totals for {{ $date_filter }}</h2>
        </div>
            ...
            <div class="table-responsive">
              <table class="table table-striped table-bordered bootstrap-datatable datatable">
                ...
                <tr>
                  ...
                  <th>{{ $date_filter->first_date }} Cost</th>
                  <th>{{ $date_filter->second_date }} Cost</th>
                  <th>{{ $date_filter->third_date }} Cost</th>
                ...
                @for($hour = 0; $hour < 24; $hour++)
                  <tr>
                    ...
                    <td>{{ money_format('%.2n', $summaries['hourly']['first_date'][$hour]['cost']) }}</td>
                    <td>{{ money_format('%.2n', $summaries['hourly']['second_date'][$hour]['cost']) }}</td>
                    <td>{{ money_format('%.2n', $summaries['hourly']['third_date'][$hour]['cost']) }}</td>
                ...
                <td>@php money_format('%.2n', $summaries['daily']['first_date']['cost']) @endphp</td>
                <td>@php money_format('%.2n', $summaries['daily']['second_date']['cost']) @endphp</td>
                <td>@php money_format('%.2n', $summaries['daily']['third_date']['cost']) @endphp</td>
